...
public class ParsingContext {
	...
	private HashMap<String, HashMap<String, Object>> customConextProperties;
	...
	public ParsingContext(String name, String logSource) {
		...
		customConextProperties = new HashMap<String, HashMap<String, Object>>();
	}

	public HashMap<String, HashMap<String, Object>> getCustomConextProperties() {
		return customConextProperties;
	}

	public void setCustomConextProperties(
			HashMap<String, HashMap<String, Object>> customConextProperties) {
